    ...
    <div>
      ...
      <div style={{ background:'linear-gradient(135deg,#1B2B4B,#2d4a80)', borderRadius:14, padding:'18px 20px', color:'#fff', marginBottom:14, display:'flex', alignItems:'center', gap:16, flexWrap:'wrap' }}>
        ...
        <div style={{ marginLeft:12 }}>
          ...
          <div style={{ fontSize:20, fontWeight:900 }}>7<span style={{ fontSize:12, opacity:.6 }}>件</span></div>
        </div>
      ...
      <div className="two-col">
        <div className="card">
          <div className="card-head"><h3>本日の架電ログ</h3><span className="c-sub">7件</span></div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="kpi-row kpi-2" style={{ marginBottom:14 }}>
              <div className="kpi-card c-green" style={{ padding:12 }}><div className="kpi-label">通話成立</div><div className="kpi-val">5<span>件</span></div><div className="kpi-change up">成功率 71%</div></div>
              <div className="kpi-card c-blue" style={{ padding:12 }}><div className="kpi-label">架電総数</div><div className="kpi-val">7<span>件</span></div></div>
            </div>
            <div style={{ fontSize:11, fontWeight:700, color:'#64748B', marginBottom:8 }}>サイト別 新規検知</div>
            {[
              { label:'引越し侍', color:'#1E5FA8', pct:68, val:'2件' },
              { label:'価格.com', color:'#0E8A7A', pct:34, val:'1件' },
