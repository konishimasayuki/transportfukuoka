...
BLOCKS = [
    ...
    ('確認日',           182.9,  52.0,  20.89,  22.31),
    ('作業内容の確認',      5.5,  85.3,   49.1,  15.70),
    ('ピアノU・G',       55.51,  85.3,  50.33, 15.70),
    ('エアコン移設',      106.8,  85.3,   97.1,  15.70),
    ('作業状況',           5.5, 104.1,  198.4,  11.4),
    ('家財表',            5.51, 116.33, 198.43, 64.10),
    ('請求先',             5.6, 181.0,  148.7,  18.05),
    ('お支払方法',        154.9, 180.2,   49.3,  18.67),
    ('その他の料金',      154.9, 199.59,  49.3,  74.31),
    ('お約束事項',         5.6, 199.6,  148.7,  31.27),
    ('料金A',             5.46, 231.64,  46.85, 42.68),
    ('料金B',            52.31, 231.64,  47.10, 42.68),
    ('料金C',            99.41, 231.64,  55.87, 42.68),
